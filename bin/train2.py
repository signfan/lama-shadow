...
def main(config: OmegaConf):
    try:
        ...
        checkpoint_path = '/home/shk/Work/lama/big-lama/models/best.ckpt'
        #checkpoint_path = '/home/shk/Work/lama2/experiments_shadow/shk_2022-02-04_13-34-06_train2_big-lama-shadow-HSV_/models/last.ckpt'
        training_model = load_checkpoint(config, checkpoint_path, strict=False, map_location='cuda')
